...
`endif
  ...
  output mst_req_t  [Cfg.NoMstPorts-1:0][Cfg.NoSlvPorts-1:0]            mst_ports_req_o,
  /// AXI4+ATOP responses to the master ports.  
  input  mst_resp_t [Cfg.NoMstPorts-1:0][Cfg.NoSlvPorts-1:0]            mst_ports_resp_i,
...
`endif
  ...
  `AXI_TYPEDEF_B_CHAN_T(mst_b_chan_t, id_slv_t, user_t)
  `AXI_TYPEDEF_B_CHAN_T(slv_b_chan_t, id_slv_t, user_t)
  `AXI_TYPEDEF_AR_CHAN_T(mst_ar_chan_t, addr_t, id_slv_t, user_t)
  `AXI_TYPEDEF_AR_CHAN_T(slv_ar_chan_t, addr_t, id_slv_t, user_t)
  `AXI_TYPEDEF_R_CHAN_T(mst_r_chan_t, data_t, id_slv_t, user_t)
  ...
  mst_req_t   [Cfg.NoMstPorts-1:0][Cfg.NoSlvPorts-1:0] mst_reqs;
  mst_resp_t  [Cfg.NoMstPorts-1:0][Cfg.NoSlvPorts-1:0] mst_resps;
