...
| [`axi_demux_simple`](src/axi_demux_simple.sv)               | 스필 레지스터가 없는 디멀티플렉서.                                                                      | [문서](doc/axi_demux.md)         |
| [`axi_demux`](src/axi_demux.sv)                             | AXI 버스를 하나의 슬레이브 포트에서 여러 마스터 포트로 디멀티플렉싱합니다.                              | [문서](doc/axi_demux.md)         |
...
| [`axi_id_remap`](src/axi_id_remap.sv)                       | 슬레이브 포트의 넓은 AXI ID를 마스터 포트의 좁은 ID로 재매핑합니다.                                    | [문서][doc.axi_id_remap]         |
| [`axi_id_serialize`](src/axi_id_serialize.sv)               | 필요한 경우 트랜잭션을 직렬화하여 AXI ID를 줄입니다.                                                   | [문서][doc.axi_id_serialize]     |
...
| [`axi_iw_converter`](src/axi_iw_converter.sv)               | 임의의 두 AXI ID 폭 간 변환.                                                                           | [문서][doc.axi_iw_converter]     |
...
| [`axi_lite_demux`](src/axi_lite_demux.sv)                   | AXI4-Lite 버스를 하나의 슬레이브 포트에서 여러 마스터 포트로 디멀티플렉싱합니다.                       | [문서](doc/axi_lite_demux.md)    |
| [`axi_lite_dw_converter`](src/axi_lite_dw_converter.sv)     | 두 AXI-Lite 버스 간의 데이터 폭 변환기.                                                                | [문서][doc.axi_lite_dw_converter]|
...
| [`axi_lite_mailbox`](src/axi_lite_mailbox.sv)               | 두 슬레이브 포트와 사용량 기반 인터럽트를 갖춘 AXI4-Lite 메일박스.                                    | [문서](doc/axi_lite_mailbox.md)  |
| [`axi_lite_mux`](src/axi_lite_mux.sv)                       | AXI4-Lite 슬레이브 포트들을 하나의 마스터 포트로 멀티플렉싱합니다.                                     | [문서](doc/axi_lite_mux.md)      |
| [`axi_lite_regs`](src/axi_lite_regs.sv)                     | 선택적 읽기 전용 및 보호 기능을 갖춘 AXI4-Lite 레지스터.                                              | [문서][doc.axi_lite_regs]        |
...
| [`axi_lite_xbar`](src/axi_lite_xbar.sv)                     | 임의의 수의 슬레이브 및 마스터 포트를 가진 완전 연결 AXI4-Lite 크로스바.                               | [문서](doc/axi_lite_xbar.md)     |
...
| [`axi_mux`](src/axi_mux.sv)                                 | AXI4 슬레이브 포트들을 하나의 마스터 포트로 멀티플렉싱합니다.                                          | [문서](doc/axi_mux.md)           |
...
| [`axi_xbar`](src/axi_xbar.sv)                               | 임의의 수의 슬레이브 및 마스터 포트를 가진 완전 연결 AXI4+ATOP 크로스바.                               | [문서](doc/axi_xbar.md)          |
| [`axi_xbar_unmuxed`](src/axi_xbar_unmuxed.sv)               | 임의의 수의 슬레이브 및 마스터 포트를 가진 완전 연결 AXI4+ATOP 크로스바의 디멀티플렉서 측.            | [문서](doc/axi_xbar.md)          |
